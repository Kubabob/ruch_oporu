...
pub fn h3() -> Html {
    html!(
        <p class="black">
            ...
            Nie damy rady przekonać wszystkich bliskich do tego, że warto walczyć nie tylko za sprawy, które dotyczą ich bezpośrednio.
            Nie damy rady pokazać wszystkim, że nasza miłość jest tym co w świecie dobre, piękne i warte zachodu, że jest to antyteza egoizmu i „podążania za modą”.
            Nie wszystkim uświadomimy, że nie da się z kimś przyjaźnić, współczuć komuś, a jednocześnie dokładać rękę do cierpienia tej osoby zasłaniając się zasadami i swoim konformizmem.    "}
            <br/>
            <br/>
            ...
            <br/>
            <br/>
            {"Może przyboczna zapewni o swojej przyjaźni koleżankę, która powiedziała jej, że zakochała się w dziewczynie z klasy i boi się reakcji swoich rodziców?
            Może przyboczny nie określi czegoś „pedalskim” albo „gejowym” w ramach żartów?
            Może drużynowa powie swojej przybocznej „wiem, wspieram Cię - będziesz świetną drużynową”?    "}
            <br/>
            <br/>
            {"Może instruktorka odezwie się podczas kursu phm., na którym kadra udając, że prowadzi dyskusję, tak naprawdę stara się przekazać swoją interpretację jako niepodważalną prawdę            i blokuje pojawiające się głosy sprzeciwu argumentem, że „takie są zasady”?
            Może instruktor wręczy odchodzącej instruktorce liścik z marzeniem „żeby dla każdego było miejsce przy ogniu” podczas ogniska na zakończenie organizowanego przez nich wspólnie zlotu?    "}
            <br/>
            <br/>
            ...
            <br/>
            <br/>
            {"Może referent zrozumie, że nie da się jednocześnie zapewniać kolegi, który od podstaw tworzył środowisko w małej miejscowości, o swojej tolerancji, jednocześnie zmuszając do odejścia z organizacji, podkreślając, że nie jest to dyskryminacja, a działanie według zasad?
            Może ksiądz kapelan nie wywróci oczami podczas kuźnicy na którą został zaproszony i przypomni sobie o prymacie sumienia oraz o tym w ilu sprawach kościół katolicki zmieniał już swoje nauczanie?    "}
            <br/>
            <br/>
            {"Może członkini komisji powstrzyma się od komentarza „nie chcę, żeby takie osoby wychowywały moje dzieci”  lub „to jest zboczenie, to są ludzie uzależnieni od seksu”?
            Może członek Zarządu Okręgu zastanowi się dwa razy zanim zaproponuje współpracę                  z wydarzeniem na którym padają jawnie nienawistne hasła wplecione między narrację o ochronie rodziny?    "}
            <br/>
            <br/>
