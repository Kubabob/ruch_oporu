        ...
        <div class="form-wrapper">
            ...
            <form class="form-box-wrapper">
                ...
                <div class="checkbox-wrapper">
                    ...
                    <CheckboxInput value="czy_upublicznic" name="czy_upublicznic" label="Wyrażam zgodę na upublicznienie mojego wpisu na stronie www.GranaOrientacje.pl" checked=false />
                    ...
                    <CheckboxInput value="czy_regulamin" name="czy_regulamin" label="Zgadzam się z regulaminem projektu dostępnym na stronie: regulamin." checked=false />
